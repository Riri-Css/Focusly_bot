// File: src/utils/getSmartResponse.js - CONSOLIDATED & FINAL
...
        // Core persona and rules, now as a constant
        const systemPersona = `
...
        // FIX 1: Add current date to the system prompt
...
        // FIX 2: Add recent chat history as separate messages
        const recentChats = user.recentChatMemory || [];
        recentChats.slice(-10).forEach(chat => {
            // Assuming chat object has a 'text' property and a way to determine who said it
            // For now, just using 'user' role based on your original prompt structure
...
        // Add the specific response format instruction to the prompt
